...
def pose_classification(landmarks):
	...
	if r_shoulder.x < r_wrist.x and l_wrist.x < l_shoulder.x and r_shoulder.y < r_wrist.y and l_shoulder.y < l_wrist.y and (l_heel.x - r_heel.x) < (l_shoulder.x-r_shoulder.x):
		pose_class = "ROCK"

	elif r_shoulder.x < r_wrist.x and l_wrist.y < l_shoulder.y and r_foot.y> l_foot.y and r_knee.y> l_knee:
		pose_class = "SCISSORS"

	elif r_wrist.x < r_shoulder.x and l_shoulder.x < l_wrist.x and r_wrist.y < r_elbow.y and l_wrist.y < l_elbow.y and (l_hip.x-r_hip.x)<(l_foot.x-r_foot.x) :
		pose_class = "PAPER"
